...
const TASKS: Record<AITask, TaskDefinition> = {
  ...
  text_to_image: mk("text_to_image", "genx", ["huggingface", "qwen"], 60_000, true, true, ["prompt"]),
  image_edit: mk("image_edit", "genx", ["huggingface", "qwen"], 60_000, true, true, ["image", "prompt"]),
  image_to_video: mk("image_to_video", "genx", ["huggingface", "qwen"], 120_000, true, true, ["image"]),
  text_to_video: mk("text_to_video", "genx", ["huggingface", "qwen"], 120_000, true, true, ["prompt"]),
  avatar_video: mk("avatar_video", "genx", ["huggingface", "qwen"], 120_000, true, true, ["script"]),
  speech_to_text: mk("speech_to_text", "genx", ["huggingface", "qwen"], 30_000, true, false, ["audio"]),
  text_to_speech: mk("text_to_speech", "genx", ["huggingface", "qwen"], 30_000, true, true, ["text"]),
  image_captioning: mk("image_captioning", "genx", ["huggingface", "qwen"], 30_000, true, false, ["image"]),
