  ...
  return (
    <ManagementLayout>
      <MgmtHero
        ...
        subtitle="Queue-safe workflows, onboarding guidance and CRM lifecycle state are in internal beta. No automated posting is enabled yet."
      />
      <section className="container mx-auto px-4 py-14 md:py-20">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          <p className="text-[#0f1d2e]/75 text-lg leading-relaxed">
            Built for mobile-first teams that need clearer records, fewer missed tasks and safer operational handoffs.
          </p>
