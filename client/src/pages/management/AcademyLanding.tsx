  ...
  return (
    <ManagementLayout>
      <MgmtHero
        ...
        subtitle="Guide every learner from signup to first win with checklist-led onboarding, lifecycle prompts and referral loops."
      />
      <section className="container mx-auto px-4 py-14 md:py-20">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          <p className="text-[#0f1d2e]/75 text-lg leading-relaxed">
            Foundation-ready academy growth flow with persistent onboarding metrics and campaign funnel tracking.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link href="/register"><Button className="bg-[#c5a55a] text-[#0f1d2e] hover:bg-[#d4b468]">Create Academy Account</Button></Link>
